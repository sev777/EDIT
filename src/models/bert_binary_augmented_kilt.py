...
class BertBinaryAugmented(LightningModule):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # print('self.hparams.model_checkpoint : ',self.hparams.model_checkpoint)
        # self.hparams.model_checkpoint='/home/yzc/hxq/edit2/model/FC_model_KE.ckpt'
        # print('self.hparams.model_checkpoint : ', self.hparams.model_checkpoint)
    ...
    def val_dataloader(self, shuffle=True):
        if not hasattr(self, "val_dataset"):
            self.val_dataset = BinaryAugmentedKILT(
                tokenizer=self.tokenizer,
                data_path='/home/yzc/hxq/edit2/datasets/fever-dev-kilt.jsonl',#self.hparams.dev_data_path,
                max_length=self.hparams.max_length,
                return_view=self.hparams.use_views,
            )
        return DataLoader(
